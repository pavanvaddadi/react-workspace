...
const resObj = [
  {
      ...
      "analytics": {
          "context": "seo-data-3b4e006c-219c-487e-8d97-70a2b62cb91b"
      },
      "cta": {
          "link": "https://www.swiggy.com/restaurants/the-rameshwaram-cafe-dr-rajkumar-road-malleshwaram-bangalore-673183",
  ...
  },
  {
      "info": {
          ...
          "availability": {
              "nextCloseTime": "2023-10-08 02:50:00",
              "opened": true
          },
          "badges": {
              "textExtendedBadges": [
...
function ResCard(data) {
 const {name , costForTwo, avgRating, cloudinaryImageId} = {...data.resData}

  return (
    <div className="res-card">
      <img className="my-card" src={`https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/${cloudinaryImageId}`}></img>
